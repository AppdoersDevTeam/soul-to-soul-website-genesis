    ...
    <PageLayout>
      ...
      <Section bgColor="white">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="border-t border-soul-cream pt-6">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="bg-soul-cream hover:bg-soul-sand p-3 rounded-full text-soul-stone transition-colors">
          ...
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-soul-cream">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Button 
                    type="submit" 
                    className="w-full bg-soul-sage hover:bg-soul-sage/90 text-white"
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-left">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">How do I know if coaching is right for me?</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">What's the difference between coaching and therapy?</h3>
              <p className="text-soul-stone/80">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">How long do coaching relationships typically last?</h3>
              <p className="text-soul-stone/80">
