...
const About = () => {
  return (
    <PageLayout>
      ...
      <Section bgColor="white">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-serif text-3xl mb-6 text-soul-stone text-center">Our Values</h2>
          
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            <div className="border border-soul-cream rounded-lg p-6 bg-white shadow-sm">
      ...
      <Section bgColor="cream">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/programs">
              <Button className="bg-soul-sage hover:bg-soul-sage/90 text-white px-8">
                Explore Programs
              </Button>
            </Link>
            <Link to="/contact">
              <Button variant="outline" className="border-soul-sage text-soul-sage hover:bg-soul-sage hover:text-white px-8">
                Contact Us
              </Button>
            </Link>
          </div>
