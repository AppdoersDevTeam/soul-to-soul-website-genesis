    ...
    <PageLayout>
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          <Link to="/programs">
            <Button className="bg-soul-sage hover:bg-soul-sage/90 text-white px-8 py-6">
              Explore Programs
            </Button>
          </Link>
          <Link to="/contact">
            <Button variant="outline" className="bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white hover:text-soul-sage px-8 py-6">
              Contact Us
            </Button>
          </Link>
        </div>
      ...
      {/* CTA Section */}
      <section className="bg-soul-sage text-white py-16">
        <div className="container-custom text-center">
          ...
          <Link to="/contact">
            <Button className="bg-white text-soul-sage hover:bg-soul-cream">
              Contact Us
            </Button>
          </Link>
        </div>
